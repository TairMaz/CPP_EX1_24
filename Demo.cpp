...
int main()
{
    ...
    cout << Algorithms::isConnected(g) << endl;        // Should print: "1" (true).
    cout << Algorithms::shortestPath(g, 0, 4) << endl; // Should print: 0->4.
    cout << Algorithms::isContainsCycle(g) << endl;    // Should print: "The cycle is: 1->2->3->1".
    cout << Algorithms::isBipartite(g) << endl;        // Should print: "0" (false)."
    cout << Algorithms::negativeCycle(g) << endl;    // Should print: "The negative cycle is: 1->2->3->4->1".
